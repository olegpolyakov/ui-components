...
Drawer is a component that slides in from the side of the screen to display additional content or options without navigating away from the current page.
